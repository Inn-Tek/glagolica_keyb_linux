...
xkb_symbols "common" {
    ...
    key <TLDE> { [       Cyrillic_io,       Cyrillic_IO, U0483, U0487  ] };
...
xkb_symbols "phonetic" {
    ...
    key <AE01> { [           1,      exclam, U0458, U0408  ] }; //1/!/ј/Ј
    key <AE02> { [           2,          at, U0482, U0488  ] }; //2/@/҂/о҈
    key <AE03> { [           3, numbersign, U0489 , any  ] }; //3/҃о҉ / /҇ 
    key <AE04> { [           4, dollar, backslash, bar  ] }; //4/҄ \ /҅| /҆ 
    key <AE05> { [           5, Cyrillic_SOFTSIGN, percent, any  ] };
    key <AE06> { [           6, Cyrillic_HARDSIGN, asciicircum, any  ] };
    key <AE07> { [           7,   ampersand, UA64B, UA64A  ] }; //ꙋ/Ꙋ
    key <AE08> { [           8,    asterisk, UA651, UA650  ] };//ꙑ/Ꙑ
    key <AE09> { [           9,   parenleft, U0457, U0407  ] }; //9/(/ї/Ї
    key <AE10> { [           0,  parenright, U047D, U047C  ] }; //0/)/ѽ/Ѽ 
    key <AE11> { [       minus,  underscore, U0479, U0478   ] }; //-/_/ ѹ/Ѹ

    key <AB09> { [      period,     question, U0300, any  ] }; //./?/
    key <AB10> { [       U046B,    U046A, U046D, U046C  ] }; //ѫ/Ѫ/ѭ/Ѭ
    key <AB08> { [       comma,        slash, U0301, any  ] }; //,///
    key <AC10> { [   U0454, U0404, U0465, U0464 ] }; //є/Є/ѥ/Ѥ
    key <AC11> { [  U0467, U0466,  U0469, U0468 ] }; //ѧ/Ѧ/ѩ/Ѩ
    key <LSGT> { [         bar,   brokenbar, any, any  ] };

    key <TLDE> { [       Cyrillic_yu,       Cyrillic_YU, U0483, U0487  ] }; //ю/Ю/҃/҇
    key <LatQ> { [       Cyrillic_ya,       Cyrillic_YA, U0463, U0462  ] }; //я/Я/ѣ/ѣ
    key <LatZ> { [       Cyrillic_ze,       Cyrillic_ZE, U0455, U0405  ] }; //з/З/ѕ/Ѕ
    key <LatS> { [       Cyrillic_es,       Cyrillic_ES, U046F, U046E  ] }; //с/С/ѯ/Ѯ
    key <LatA> { [        Cyrillic_a,        Cyrillic_A, UA657, UA656  ] }; //а/А/ꙗ/Ꙗ
    key <LatW> { [       Cyrillic_ve,       Cyrillic_VE, U0461, U0460  ] }; //в/В/ѡ/Ѡ
    key <LatC> { [      Cyrillic_tse,      Cyrillic_TSE, U045B, U040B  ] }; //ц/Ц/ћ/Ћ
    key <LatX> { [ Cyrillic_softsign, Cyrillic_hardsign, U0452, U0402  ] }; //ь/ъ/ђ/Ђ
    key <LatD> { [       Cyrillic_de,       Cyrillic_DE, U045F, U040F  ] }; //д/Д/џ/Џ
    key <LatE> { [       Cyrillic_ie,       Cyrillic_IE, U0450, U0400  ] }; //е/Е/ѐ/Ѐ
    key <LatV> { [      Cyrillic_zhe,      Cyrillic_ZHE, U0477, U0476  ] }; //ж/Ж/ѷ/Ѷ
    key <LatF> { [       Cyrillic_ef,       Cyrillic_EF, U0473, U0472  ] }; //ф/Ф/ѳ/Ѳ
    key <LatT> { [       Cyrillic_te,       Cyrillic_TE, U047F, U047E  ] }; //т/Т/ѿ/Ѿ
    key <LatR> { [       Cyrillic_er,       Cyrillic_ER, U048E, U048F  ] };//р/Р/Ҏ/ҏ
    key <LatN> { [       Cyrillic_en,       Cyrillic_EN, U045A, U040A  ] }; //н/Н/њ.Њ
    key <LatB> { [       Cyrillic_be,       Cyrillic_BE, U04A6, U04A7  ] }; //б/Б/Ҧ/ҧ
    key <LatH> { [       Cyrillic_ha,       Cyrillic_HA, U0491, U0490  ] };//х/Х/ґ/Ґ
    key <LatG> { [      Cyrillic_ghe,      Cyrillic_GHE, U0453, U0403  ] }; //г/Г/ѓ/Ѓ
    key <LatY> { [     Cyrillic_yeru,     Cyrillic_YERU, U0475, U0474  ] }; //ы/Ы/ѵ/Ѵ
    key <LatM> { [       Cyrillic_em,       Cyrillic_EM, U04A4, U04A5  ] }; //м/М/Ҥ/ҥ
    key <LatJ> { [   Cyrillic_shorti,   Cyrillic_SHORTI, U045D, U040D  ] }; //й/Й/ѝ/Ѝ
    key <LatU> { [        Cyrillic_u,        Cyrillic_U, U045E, U040E  ] }; //у/У/ў/Ў
    key <LatK> { [       Cyrillic_ka,       Cyrillic_KA, U045C, U40C  ] }; //к/К/ќ/Ќ
    key <LatI> { [        Cyrillic_i,        Cyrillic_I, U0456, U0406  ] }; //и/И/і/І
    key <LatO> { [        Cyrillic_o,        Cyrillic_O, U047B, U047A  ] }; //о/О/ѻ/Ѻ
    key <LatL> { [       Cyrillic_el,       Cyrillic_EL, U0459, U0409  ] }; //л/Л/љ/Љ
    key <LatP> { [       Cyrillic_pe,       Cyrillic_PE, U0471, U0470  ] }; //п/П/ѱ/Ѱ

    key <AD11> { [      Cyrillic_sha,      Cyrillic_SHA, U0485, any  ] };
    key <AD12> { [    Cyrillic_shcha,    Cyrillic_SHCHA, U0486, any  ] };
    key <AE12> { [      Cyrillic_che,      Cyrillic_CHE, equal, plus  ] };
    
    key <BKSL> { [        Cyrillic_e,        Cyrillic_E, Cyrillic_io, Cyrillic_IO  ] }; //э/Э/ё/Ё
