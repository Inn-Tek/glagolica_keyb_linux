...
key <TLDE> { [  grave,	asciitilde,U0483, U0487 ] };//҃/́ /҇/҄
key <AD01> { [ U2C23, U2C2D, any, any ] };//q/Q/Ⱓ/Ⱝ/
key <AD02> { [ U2C02, any, any, any ] };//w/W/Ⰲ
key <AD03> { [ U2C24, U2C05, U2C25, U2C27 ] };//e/E/Ⱔ/Ⰵ/Ⱕ/Ⱗ/
key <AD04> { [ U2C13, any, any, any ] };//r/R/Ⱃ/
key <AD05> { [ U2C15, any, any, any ] };//t/T/Ⱅ/
key <AD06> { [ U2C09, U2C2B, any, any ] };//y/Y/Ⰹ/Ⱛ/
key <AD07> { [ U2C16, any, any, any ] };//u/U/Ⱆ/
key <AD08> { [ U2C0B, any, any, any ] };//i/I/Ⰻ/
key <AD09> { [ U2C11, U2C26, U2C19, U2C29 ] };//o/O/Ⱁ/Ⱖ/Ⱉ/Ⱙ
key <AD10> { [ U2C12, U2C1A, any, any ] };//p/P/Ⱂ/Ⱊ/
key <AD11> { [ any, any, U0485, any ] };//[/{//
key <AD12> { [ any, any, U0486, any ] };//]/}//
key <AC01> { [ U2C00, U2C21, U2C28, U2C29 ] };//a/A/Ⰰ/Ⱑ/Ⱘ/Ⱙ/
key <AC02> { [ U2C14, U2C1E, U2C1B, any ] };//s/S/Ⱄ/Ⱎ/Ⱋ/
key <AC03> { [ U2C04, U2C07, U2C0C, any ] };//d/D/Ⰴ/Ⰷ/Ⰼ/
key <AC04> { [ U2C17, U2C2A, any, any ] };//f/F/Ⱇ/Ⱚ/
key <AC05> { [ U2C03, U2C03, any, any ] };//g/G/Ⰳ/Ⰳ/
key <AC06> { [ U2C18, U2C22, any, any ] };//h/H/Ⱈ/Ⱒ/
key <AC07> { [ U2C0A, U2C2C, any, any ] };//j/J/Ⰺ/Ⱜ/
key <AC08> { [ U2C0D, any, any, any ] };//k/K/Ⰽ/
key <AC09> { [ U2C0E, any, any, any ] };//l/L/Ⰾ/
key <AC12> { [ any, any, any, any ] };//\/|/
key <AC10> { [ any, any, semicolon,	colon ] };// / /;/:/
key <AC11> { [ any, any,apostrophe,	quotedbl ] };// / /҆'/"
key <AB01> { [ U2C08, U2C06, any, any ] };//z/Z/Ⰸ/Ⰶ/
key <AB02> { [ U2C20, U2C1F, any, any ] };//x/X/Ⱐ/Ⱏ/
key <AB03> { [ U2C1C, U2C1D, any, any] };//c/C/Ⱌ/Ⱍ/
key <AB04> { [ U2C02, any, any, any ] };//v/V/Ⰲ/ 
key <AB05> { [ U2C01, any, any, any ] };//b/B/Ⰱ/
key <AB06> { [ U2C10, any, any, any ] };//n/N/Ⱀ/
key <AB07> { [ U2C0F, U2C2E, any, any ] };//m/M/Ⰿ/Ⱞ/

key <AB08> {	[     comma,	less, U0301, any		]	};
key <AB09> {	[    period,	greater,	U0300, any 	]	};
